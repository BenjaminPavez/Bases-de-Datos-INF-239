<?php
/*
La plantilla muestra la informacion de cada paquete
...
//Recibe el id del paquete a buscar
$id = $_POST["valor"];

//Realiza la consulta a la tabla paquete
$sql = "SELECT * FROM paquete WHERE id = $id";
...
if ($resultado) {
    if ($resultado->num_rows > 0) {
        while ($fila = $resultado->fetch_assoc()) {
            ...
            $aerolinea_ida = $fila['aerolinea_ida'];
            $aerolinea_vuelta = $fila['aerolinea_vuelta'];
            $nombre_hotel = $fila['Hotel'];
			...
			$nro_noches = $fila['noches_totales'];    
        }
    }
}
...
$sql2 = "SELECT c.n_estrellas, c.opinion, 
        u.name AS nombre_usuario FROM calificaciones c 
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="p-4" style="margin-left: 60px; font-size: 16px;">
                            ...
                            <p class="lead">
                                <span class="precio" style="font-size: 25px;"><?php echo $nro_noches; ?> noches</span>
                            </p>
							<p class="lead">
                                <?php
                                $precioFormateado = number_format($precio_persona, 0, ',', '.');
                                ?>
                                <span class="precio" style="font-size: 20px;">CLP <?php echo $precioFormateado; ?> por persona</span>
                            </p>
                            ...
                            <div class="package-item-summary">
                                <div data-v-2c1ca5c2="" class="package-item-row package-item-dates">
                                    <div data-v-2c1ca5c2="" class="package-info-title">
                                        Aerolinea de Ida: <?php echo $aerolinea_ida; ?>
                                    </div>
                                </div>
                                <div data-v-14e3ce94="" class="package-item-row package-item-dates">
                                    <div data-v-14e3ce94="" class="package-info-title">
										Aerolinea de Vuelta: <?php echo $aerolinea_vuelta; ?>
                                    </div>
                                </div>
                                <div data-v-2c1ca5c2="" class="package-item-row package-item-dates">
                                    <div data-v-2c1ca5c2="" class="package-info-title">
                                        Ciudad(s): <?php echo $nombre; ?>
                                    </div>
                                </div>
                                <div data-v-2c1ca5c2="" class="package-item-row package-item-dates">
                                    <div data-v-2c1ca5c2="" class="package-info-title">
                                        Hotel(es): <?php echo $nombre_hotel; ?>
                                    </div>
                                </div>
								<div data-v-2c1ca5c2="" class="package-item-row package-item-dates">
                                    <div data-v-2c1ca5c2="" class="package-info-title">
                                        Maximo de personas: <?php echo $max_personas; ?>
                                    </div>
                                </div>
								<div data-v-2c1ca5c2="" class="package-item-row package-item-dates">
                                    <div data-v-2c1ca5c2="" class="package-info-title">
                                        Fecha de Inicio: <?php echo $fecha_i; ?>
                                    </div>
                                </div>
								<div data-v-2c1ca5c2="" class="package-item-row package-item-dates">
                                    <div data-v-2c1ca5c2="" class="package-info-title">
                                        Fecha de Termino: <?php echo $fecha_t; ?>
                                    </div>
                                </div>
                            ...
                            <p></p>
                            <p>Stock disponible: <?php echo $stock; ?> |  <?php echo $totales; ?></p>
                            <script>
                                // Función para validar las fechas al enviar el formulario
                                function validarFechas() {
                                    ...
                                    var fechaMin = new Date('<?php echo $fecha_i; ?>');
                                    var fechaMax = new Date('<?php echo $fecha_t; ?>');

                                    if (fechaInicio < fechaMin || fechaInicio > fechaMax) {
                                    alert('La fecha de llegada está fuera del rango permitido.');
                                    return false;
                                    }

                                    if (fechaSalida < fechaMin || fechaSalida > fechaMax) {
                                    alert('La fecha de salida está fuera del rango permitido.');
                                    return false;
                                    }
                            ...
                            <p></p>
                            <form class="d-flex flex-column align-items-start" method="post" action="compra_paquete.php">
                                <div class="mb-3" style="width: 300px;">
                                    <label for="cantidad" class="form-label">Unidades:</label>
                                    <input style="height: 30px;" type="number" name="cantidad" id="cantidad" value="1" class="form-control" min="0" max="<?php echo $stock; ?>" required>
                                </div>
                                <p></p>
								<input type="hidden" name="id_paquete" value="<?php echo $id; ?>">
                                <button style="text-align: center;" class="btn btn-primary btn-lg" type="submit">Comprar</button>
                            </form>
							<form class="d-flex flex-column align-items-start"  style="position: relative; right: -130px; top: -32px;" action="wishlist.php" method="post">
                                <input type="hidden" name="paquete" value="<?php echo $id; ?>">
                                <button style="text-align: center;" class="btn btn-primary btn-lg" type="submit">Agregar a Wishlist</button>
							</form>
                            <p></p>
                                                ...
                                                <div class="fh5co-blog animate-box">
                                                    ...
                                                    <div class="blog-text">
                                                        <div class="prod-title">
                                                            ...
                                                            <span class="posted_by">Del <?php echo $fecha_i; ?> a <?php echo $fecha_t; ?></span>
