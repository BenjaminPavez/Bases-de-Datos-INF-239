<?php
/*
La plantilla muestra las opiniones que realizo el usuario
...
//Realiza la consulta para obtener toda la informacion de las opiniones, las valoraciones y los respectivos datos del hotel o paquete
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Mis Opiniones</h3>
                                    ...
                                    <table class="table user-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Valoracion</th>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div data-v-23c78582="">
                                                        <div data-v-23c78582="" class="stars">
                                                            <?php for ($i = 0; $i < $cantidad_estrellas; $i++) { ?>
                                                                <i style="font-size: 15px;" data-v-23c78582="" class="icon-star"></i>
                                                            <?php } ?>
                                                        </div>
                                                    </div>
                                                </td>
            ...
            <footer class="footer"> © 2023 Prestigetravels by USM <a href="https://www.wrappixel.com/"></a>
            </footer>
        </div>
    </div>
